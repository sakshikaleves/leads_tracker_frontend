...
import { z } from 'zod';
import { ChevronLeft, AlertTriangle, ChevronDown, X, Paperclip, Link2, Plus } from 'lucide-react';
...
// Convert ISO alpha-2 code to flag emoji (works on all modern platforms)
...
export function AddLead() {
  ...
  const [selectedCC, setSelectedCC] = useState(countryCodes[0]); // Default: India +91
